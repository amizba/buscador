...
<title>Buscador con PHP & MySQL</title>
<!-- Bootstrap core CSS -->
  ...
  <body>
    ...
    <header>
      ...
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <a class="navbar-brand" href="index.php">amizba@gmail.com</a>
...
<div class="container">
 <h4 class="mt-5">Buscadorcon PHP & MySQL</h4>
 <hr>
...
<!-- Fin Contenido --> 
    ...
    <footer class="footer">
      <div class="container">
        <span class="text-muted"><p>Proyectos y scripts con PHP y MySQL</p></span>
      </div>
    </footer>
